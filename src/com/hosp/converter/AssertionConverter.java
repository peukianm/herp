...
public class AssertionConverter implements Converter {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent component, String submittedValue) {
        if (submittedValue.trim().isEmpty()) {
            ...
            try {
                ...
                ExAssertion assertion = persistenceHelper.getEntityManager().find(ExAssertion.class, number);
                return assertion;
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object value) {
        try {
            if (value == null || value.equals("")) {
                ...
                return String.valueOf(((ExAssertion) value).getAssertionid());
            }
        } catch (Exception e) {
            e.printStackTrace();
            return "";
