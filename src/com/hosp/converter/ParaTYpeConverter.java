...
public class ParaTYpeConverter implements Converter {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent component, String submittedValue) {
        if (submittedValue.trim().isEmpty()) {
            ...
            try {
                ...
                ExParaType paraType = persistenceHelper.getEntityManager().find(ExParaType.class, number);
                return paraType;
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object value) {
        try {
            if (value == null || value.equals("")) {
                ...
                return String.valueOf(((ExParaType) value).getParatypeid());
            }
        } catch (Exception e) {
            e.printStackTrace();
            return "";
