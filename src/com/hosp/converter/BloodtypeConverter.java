...
public class BloodtypeConverter implements Converter {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent component, String submittedValue) {
        if (submittedValue.trim().isEmpty()) {
            ...
            try {
                ...
                Bloodtype bloodtype = persistenceHelper.getEntityManager().find(Bloodtype.class, number);
                return bloodtype;
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object value) {
        try {
            if (value == null || value.equals("")) {
                ...
                return String.valueOf(((Bloodtype) value).getBloodtypeid());
            }
        } catch (Exception e) {
            e.printStackTrace();
            return "";
