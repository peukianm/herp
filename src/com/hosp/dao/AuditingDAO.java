...
public class AuditingDAO {
    ...
    private static final Logger logger = Logger.getLogger(AuditingDAO.class);
    ...
    public void delete(Auditing entity) {
        ...
        try {
            entity = getEntityManager().getReference(Auditing.class, entity.getAuditid());
