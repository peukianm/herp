...
/**
 * A data access object (DAO) providing persistence and search support for Department entities. Transaction control of the save(), update() and delete()
...
public class DepartmentDAO {
    ...
    public static final String EXTRAORDER = "extraorder";
    ...
    /**
     * Perform an initial save of a previously unsaved Department entity. All subsequent persist actions of this entity should use the #update() method. This
     ...
     * </pre>
     *
     * @param entity Department entity to persist
    ...
    /**
     * Delete a persistent Department entity. This operation must be performed within the a database transaction context for the entity's data to be permanently
     ...
     * </pre>
     *
     * @param entity Department entity to delete
     * @throws RuntimeException when the operation fails
     */
    ...
    /**
     * Persist a previously saved Department entity and return it or a copy of it to the sender. A copy of the Department entity parameter is returned when the
     ...
     * </pre>
     *
     * @param entity Department entity to update
     * @return Department the persisted Department entity instance, may not be the same
     * @throws RuntimeException if the operation fails
     */
    public Department update(Department entity) {

        try {
            Department result = getEntityManager().merge(entity);
     ...
     *
     * @param propertyName the name of the Department property to query
    ...
    public List<Department> findByProperty(String propertyName, final Object value, final int... rowStartIdxAndCount) {

        try {
            final String queryString = "select model from Department model where model." + propertyName + "= :propertyValue";
    ...
    public List<Department> findByName(Object name, int... rowStartIdxAndCount) {
        return findByProperty(NAME, name, rowStartIdxAndCount);
    }

    public List<Department> findByExtraorder(Object extraorder, int... rowStartIdxAndCount) {
        return findByProperty(EXTRAORDER, extraorder, rowStartIdxAndCount);
    }

    public List<Department> findByType(Object type, int... rowStartIdxAndCount) {
